...
import { Badge, Button, Checkbox, Dialog, Field, HStack, Input, Portal, Stack, Table, Text } from '@chakra-ui/react';
...
export default function ApiKeysPage() {
  ...
  const create = useMutation({
    mutationFn: () => api.post('/integrations/api-keys', { name, scopes }).then((r) => r.data),
    onSuccess: (data) => { queryClient.invalidateQueries({ queryKey: ['integration-api-keys'] }); setOpen(false); setName(''); setScopes(['PIX_CREATE']); setCreatedToken(data.token); },

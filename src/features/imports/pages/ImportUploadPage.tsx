...
const IMPORT_FIELDS = [
  ...
  { value: 'occurrenceDate', label: 'Data de contratação (opcional)', required: false },
  ...
  { value: 'productAdhesionDate', label: 'Data de adesão ao produto', required: false },
...
const HEADER_SUGGESTIONS: Record<string, string> = {
  ...
  m_contrato: 'occurrenceDate', mes_contrato: 'occurrenceDate', data_ocorrencia: 'occurrenceDate', data_contratacao: 'occurrenceDate',
  vencimento: 'dueDate', data_vencimento: 'dueDate',
  data_cadastro: 'productAdhesionDate', data_adesao: 'productAdhesionDate', data_adesao_produto: 'productAdhesionDate',

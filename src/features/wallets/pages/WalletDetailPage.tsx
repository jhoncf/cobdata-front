...
export default function WalletDetailPage() {
  ...
  const handleEditWallet = (formData: { name: string; creditorId: string; serasaWalletExternalId: string; cobcomDiscountPercent: number; offerFirstInstallmentDays: number; offerMinInstallmentValue: number; offerMaxInstallments: number; defaultDebtType: string; smsTemplate: string; discountBands?: UpdateWalletDto['discountBands'] }) => {
    updateWalletMutation.mutate(
      { id: id!, data: { name: formData.name, serasaWalletExternalId: formData.serasaWalletExternalId, cobcomDiscountPercent: formData.cobcomDiscountPercent, offerFirstInstallmentDays: formData.offerFirstInstallmentDays, offerMinInstallmentValue: formData.offerMinInstallmentValue, offerMaxInstallments: formData.offerMaxInstallments, defaultDebtType: formData.defaultDebtType, smsTemplate: formData.smsTemplate, discountBands: formData.discountBands } },

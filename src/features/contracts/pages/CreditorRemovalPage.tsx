...
type Preview = { totalLines: number; validLines: number; invalidLines: number; matchedCount: number; unmatchedCount: number; blockedCount: number; duplicateLines: number; samples: Array<{ contractNumber: string; debtorDocument: string }> };
...
export default function CreditorRemovalPage() {
  ...
  return <Stack gap="5">
    ...
    <Card.Root><Card.Body gap="4">
      <Stack gap="1"><Text fontWeight="semibold">Importar arquivo para remoção em massa</Text><Text fontSize="sm" color="fg.muted">Envie CSV ou XLSX. Antes da confirmação, o CRM confere o número do contrato e CPF/CNPJ. Somente cadastros do seu credor podem ser removidos.</Text></Stack>
